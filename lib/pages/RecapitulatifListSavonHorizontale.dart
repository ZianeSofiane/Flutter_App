...
class maListeDeSavonsHorizontale extends StatelessWidget {
  ...
  */
  Widget build(BuildContext context) {
    return SingleChildScrollView( // le fait de swiper
          child: Column(
            children: [
              //titredelapage,
              alignement,
...
Widget savonUnique = Container(
    ...
    decoration: BoxDecoration(
        ...
        gradient: const LinearGradient( //dégradé de couleur
            ...
            [
              Colors.red, // du bleu
              Colors.purple, // au jaune
              Colors.blue, //jusqu'au vert
            ]
        )
...
Widget boutonSupprimer = Container(
    child : IconButton(
      ...
      onPressed: () {
        MaterialPageRoute<maListeDeSavonsHorizontale>(builder: (context) => maListeDeSavonsHorizontale());
      },
    )
);
